  ...
  <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:600px; margin:0 auto; background:#FFFFFF; border:1px solid #E5E7EB;">
    <tr>
      <td style="background-color:#1A1C4F; padding:34px 40px;">
        ...
        <div style="font-size:11px; letter-spacing:3px; color:#F57F20; text-transform:uppercase; margin-top:22px;">Account security</div>
        <div style="font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:20px; font-weight:600; color:#F8F9FD; margin-top:12px; word-break:break-all;">{{ $email }}</div>
      </td>
    </tr>
    <tr>
      <td style="padding:38px 40px;">
        <h1 style="margin:0 0 18px; font-size:28px; color:#1A1C4F;">Reset your password</h1>
        <p style="margin:0 0 16px; font-size:16px; line-height:26px; color:#3A3D4D;">Hi {{ $firstName }},</p>
        <p style="margin:0 0 24px; font-size:16px; line-height:26px; color:#3A3D4D;">
          We received a request to reset the password for your VIU customer portal account. Click the button below to choose a new password.
        </p>
        <table role="presentation" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 24px;">
          <tr>
            <td style="border-radius:0;" bgcolor="#F57F20">
              <a href="{{ $resetUrl }}" style="display:inline-block; background-color:#F57F20; color:#1A1C4F; font-size:15px; font-weight:700; line-height:52px; text-align:center; text-decoration:none; border-radius:0; padding:0 40px;">Reset password &nbsp;<span aria-hidden="true">&rarr;</span></a>
            </td>
          </tr>
        </table>
        <p style="margin:0; padding:20px 24px; border-left:3px solid #F57F20; background:#FAFAFC; color:#3A3D4D; font-size:14px; line-height:22px;">
          This link expires in {{ $expireMinutes }} {{ str('minute')->plural($expireMinutes) }}.
