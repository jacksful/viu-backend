...
<head>
  ...
  <style>
    ...
    @media only screen and (max-width:600px) {
      ...
      .email-display { font-size:18px !important; letter-spacing:0 !important; }
...
<body style="margin:0; padding:0; background-color:#F1F2F7;">
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all; font-family:sans-serif;">
    Confirm your email to finish setting up your VIU customer portal account.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-radius:0; overflow:hidden;">
                ...
                <tr>
                  <td style="background-color:#1A1C4F; padding:34px 40px 30px 40px;" class="px">
                    ...
                    <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:11px; letter-spacing:3px; color:#F57F20; text-transform:uppercase; margin-bottom:14px;">Account setup &middot; Verify email</div>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #3D40A0; border-radius:0;">
                      <tr>
                        <td class="stack stack-pad" style="padding:20px 24px;" valign="middle">
                          <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:9px; letter-spacing:2.5px; color:#A9ADD8; text-transform:uppercase; margin-bottom:8px;">Email</div>
                          <div class="email-display display-font" style="font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:20px; font-weight:600; letter-spacing:-0.2px; color:#F8F9FD; line-height:1.3; word-break:break-all;">{{ $email }}</div>
                        </td>
                        ...
                        <td class="stack stack-pad" width="186" align="left" style="padding:20px 24px;" valign="middle">
                          ...
                          <span style="display:inline-block; background-color:#F57F20; padding:7px 12px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:10px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#1A1C4F;">Pending verification</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td class="px" style="padding:38px 40px 8px 40px;">
                    <h1 class="h1 display-font" style="margin:0 0 18px 0; font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:33px; line-height:40px; font-weight:800; color:#1A1C4F; letter-spacing:-0.3px;">Verify your email address.</h1>
                    ...
                    <p class="body-font" style="margin:0 0 8px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; line-height:26px; color:#3A3D4D;">Thanks for signing up. Please click the button below to confirm <strong style="color:#1A1C4F;">{{ $email }}</strong> and finish setting up your VIU customer portal account.</p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="border-radius:0;" bgcolor="#F57F20">
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $verificationUrl }}" style="height:52px;v-text-anchor:middle;width:320px;" arcsize="0%" stroke="f" fillcolor="#F57F20">
                          <w:anchorlock/><center style="color:#1A1C4F;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:bold;">Verify email address</center>
                          </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-- -->
                          <a href="{{ $verificationUrl }}" style="display:inline-block; background-color:#F57F20; color:#1A1C4F; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; font-weight:700; line-height:52px; text-align:center; text-decoration:none; border-radius:0; padding:0 40px;">Verify email address &nbsp;<span aria-hidden="true">&rarr;</span></a>
                          <!--<![endif]-->
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td class="px" style="padding:26px 40px 0 40px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-left:3px solid #F57F20; border-radius:0;">
                      <tr>
                        <td style="padding:20px 24px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D;">This link expires in <strong style="color:#1A1C4F;">{{ $expireMinutes }}</strong> minutes. If you didn&rsquo;t create an account, no further action is required.</td>
                      </tr>
                    </table>
                  </td>
                </tr>
          ...
          <tr>
            <td class="px" style="padding:26px 40px 8px 40px;">
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr><td align="center" style="padding-top:14px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:12px; line-height:19px; color:#5F6677;">You&rsquo;re receiving this because you signed up for a VIU account.<br><a href="mailto:{{ $supportEmail }}" style="color:#5F6677; text-decoration:underline;">Contact us</a></td></tr>
              </table>
            </td>
          </tr>
