...
<head>
  ...
  <title>We received your ZIP request</title>
  <!--[if mso]>
...
<body style="margin:0; padding:0; background-color:#F1F2F7;">
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all; font-family:sans-serif;">
    ZIP {{ $zipCode }} is open and on a 48-hour hold for you. Complete your secure checkout to lock it in for good.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-radius:0; overflow:hidden;">
                ...
                <tr>
                  <td style="background-color:#1A1C4F; padding:34px 40px 30px 40px;" class="px">
                    ...
                    <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:11px; letter-spacing:3px; color:#F57F20; text-transform:uppercase; margin-bottom:14px;">
                      Territory on hold for you
                    </div>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #3D40A0; border-radius:0;">
                      <tr>
                        ...
                        <td class="stack stack-pad" width="186" align="left" style="padding:20px 24px;" valign="middle">
                          ...
                          <span style="display:inline-block; border:1px solid #F57F20; padding:6px 11px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:10px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#F57F20;">Open &middot; 48-hr hold</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td class="px" style="padding:38px 40px 8px 40px;">
                    <h1 class="h1 display-font" style="margin:0 0 18px 0; font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:33px; line-height:40px; font-weight:800; color:#1A1C4F; letter-spacing:-0.3px;">
                      ZIP {{ $zipCode }} is open. Lock it in.
                    </h1>
                    <p class="body-font" style="margin:0 0 16px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; line-height:26px; color:#3A3D4D;">
                      Hi {{ $firstName }},
                    </p>
                    <p class="body-font" style="margin:0 0 28px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; line-height:26px; color:#3A3D4D;">
                      Great news, ZIP <strong style="color:#1A1C4F;">{{ $zipCode }}</strong> is open, and we&rsquo;ve placed a <strong style="color:#1A1C4F;">48-hour soft-hold</strong> on it for you. Complete your secure checkout below to lock it in permanently. Your subscription terms are included right in checkout, so there&rsquo;s no separate paperwork to sign.
                    </p>
                  </td>
                </tr>

                <tr>
                  <td class="px" style="padding:4px 40px 0 40px;" align="center">
                    <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        <td style="border-radius:0;" bgcolor="#F57F20">
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{ $checkoutUrl }}" style="height:52px;v-text-anchor:middle;width:340px;" arcsize="0%" stroke="f" fillcolor="#F57F20">
                          <w:anchorlock/><center style="color:#1A1C4F;font-family:Helvetica,Arial,sans-serif;font-size:15px;font-weight:bold;">Complete secure checkout &rarr;</center>
                          </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-- -->
                          <a href="{{ $checkoutUrl }}" style="display:inline-block; background-color:#F57F20; color:#1A1C4F; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; font-weight:700; line-height:52px; text-align:center; text-decoration:none; border-radius:0; padding:0 40px;">Complete secure checkout &nbsp;<span aria-hidden="true">&rarr;</span></a>
                          <!--<![endif]-->
                        </td>
                      </tr>
                    </table>
                ...
                <tr>
                  <td class="px" style="padding:14px 40px 0 40px;" align="center">
                    <p class="body-font" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:13px; line-height:20px; color:#5F6677;">
                      {{ $amount }}/mo &nbsp;&middot;&nbsp; secured by Stripe &nbsp;&middot;&nbsp; cancel anytime
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="px" style="padding:30px 40px 8px 40px;">
                    <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:11px; letter-spacing:2.5px; color:#5F6677; text-transform:uppercase; margin-bottom:18px;">What happens next</div>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
                      <tr>
                        ...
                        <td valign="top" class="body-font" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D; padding-bottom:16px;">Checkout takes about two minutes, terms and your first month are handled in one step.</td>
                      </tr>
                      <tr>
                        ...
                        <td valign="top" class="body-font" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D; padding-bottom:16px;">The moment your payment clears, we send your intake form and start building your brand.</td>
                      </tr>
                      <tr>
                        ...
                        <td valign="top" class="body-font" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D;">You go live within 7 days, and you&rsquo;re the <strong style="color:#1A1C4F;">only VIU agent</strong> in that ZIP.</td>
                      </tr>
                    </table>
                  </td>
                </tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-radius:0;">
                      <tr>
                        <td style="padding:20px 24px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D;">
                          Your hold is active for <strong style="color:#1A1C4F;">48 hours.</strong> Questions before you check out? Just reply to this email. A real person reads it.
                        </td>
                      </tr>
                    </table>
                  </td>
