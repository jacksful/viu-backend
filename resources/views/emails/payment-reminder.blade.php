...
<head>
  ...
  <title>ZIP {{ $zipCode }} hold expires in 24 hours</title>
...
<body style="margin:0; padding:0; background-color:#F1F2F7;">
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all; font-family:sans-serif;">
    Quick heads up. The soft-hold on ZIP {{ $zipCode }} expires in 24 hours. After that it returns to the pool.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-radius:0; overflow:hidden;">
                ...
                <tr>
                  <td style="background-color:#1A1C4F; padding:34px 40px 30px 40px;" class="px">
                    ...
                    <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:11px; letter-spacing:3px; color:#F57F20; text-transform:uppercase; margin-bottom:14px;">Time-sensitive</div>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #3D40A0; border-radius:0;">
                      <tr>
                        ...
                        <td class="stack stack-pad" width="186" align="left" style="padding:20px 24px;" valign="middle">
                          ...
                          <span style="display:inline-block; border:1px solid #F57F20; padding:6px 11px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:10px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#F57F20;">Expires in 24h</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td class="px" style="padding:38px 40px 8px 40px;">
                    <h1 class="h1 display-font" style="margin:0 0 18px 0; font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:33px; line-height:40px; font-weight:800; color:#1A1C4F; letter-spacing:-0.3px;">
                      Your hold on ZIP {{ $zipCode }} expires in 24 hours.
                    </h1>
                    ...
                    <p class="body-font" style="margin:0 0 28px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; line-height:26px; color:#3A3D4D;">
                      Quick heads up. The 48-hour soft-hold on ZIP <strong style="color:#1A1C4F;">{{ $zipCode }}</strong> expires in <strong style="color:#1A1C4F;">24 hours.</strong> After that, it returns to the available pool, and we keep just one agent per ZIP.
                    </p>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="px" style="padding:16px 40px 0 40px;" align="center">
                    <p class="body-font" style="margin:0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:14px; line-height:22px; color:#5F6677;">
                      Terms and your first month are handled together in one secure step. <span style="color:#1A1C4F;">No separate paperwork.</span>
                    </p>
                  </td>
                </tr>
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-radius:0;">
                      <tr>
                        <td style="padding:20px 24px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D;">
                          Need a little more time? <strong style="color:#1A1C4F;">Just reply</strong> and we&rsquo;ll help, no pressure.
                        </td>
                      </tr>
                    </table>
                  </td>
