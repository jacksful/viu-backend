...
<head>
  ...
  <title>We couldn't process your payment for ZIP {{ $zipCode }}</title>
...
<body style="margin:0; padding:0; background-color:#F1F2F7;">
  <div style="display:none; font-size:1px; line-height:1px; max-height:0; max-width:0; opacity:0; overflow:hidden; mso-hide:all; font-family:sans-serif;">
    We couldn't process your payment for ZIP {{ $zipCode }}. Update your card to keep your territory.
              ...
              <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-radius:0; overflow:hidden;">
                ...
                <tr>
                  <td style="background-color:#1A1C4F; padding:34px 40px 30px 40px;" class="px">
                    ...
                    <div style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:11px; letter-spacing:3px; color:#FCA5A5; text-transform:uppercase; margin-bottom:14px;">Payment issue</div>
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #3D40A0; border-radius:0;">
                      <tr>
                        ...
                        <td class="stack stack-pad" width="186" align="left" style="padding:20px 24px;" valign="middle">
                          ...
                          <span style="display:inline-block; border:1px solid #FCA5A5; padding:6px 11px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:10px; font-weight:700; letter-spacing:1.5px; text-transform:uppercase; color:#FCA5A5;">Payment failed</span>
                        </td>
                      </tr>
                    </table>
                  </td>
                ...
                <tr>
                  <td class="px" style="padding:38px 40px 8px 40px;">
                    <h1 class="h1 display-font" style="margin:0 0 18px 0; font-family:'Inter','Helvetica Neue',Helvetica,Arial,sans-serif; font-size:33px; line-height:40px; font-weight:800; color:#1A1C4F; letter-spacing:-0.3px;">We couldn&rsquo;t process your payment for ZIP {{ $zipCode }}.</h1>
                    ...
                    <p class="body-font" style="margin:0 0 16px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; line-height:26px; color:#3A3D4D;">Your {{ $billingIntervalLabel }} payment of <strong style="color:#1A1C4F;">{{ $amount }}</strong> for ZIP <strong style="color:#1A1C4F;">{{ $zipCode }}</strong> didn&rsquo;t go through, usually an expired or maxed-out card.</p>
                    <p class="body-font" style="margin:0 0 8px 0; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:16px; line-height:26px; color:#3A3D4D;">Your territory is still yours for now, and we&rsquo;ll automatically retry in a couple of days. To avoid any interruption, update your payment method now.</p>
                  </td>
                </tr>
                ...
                <tr>
                  <td class="px" style="padding:26px 40px 0 40px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:#FFFFFF; border:1px solid #E5E7EB; border-left:3px solid #F57F20; border-radius:0;">
                      <tr>
                        <td style="padding:20px 24px; font-family:'Helvetica Neue',Helvetica,Arial,sans-serif; font-size:15px; line-height:23px; color:#3A3D4D;">ZIP <strong style="color:#1A1C4F;">{{ $zipCode }}</strong> stays locked while we retry. If every retry fails, the ZIP returns to the pool, and one agent per ZIP means another agent could claim it.</td>
                      </tr>
                    </table>
                  </td>
                </tr>
